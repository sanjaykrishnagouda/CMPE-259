...
// Over the 3600x3600 HGT, there are ten "bumps" vertically, and 
// 15 bumps horizontally.
    ...
    if (f != NULL)
    {
        ...
        for (j = MAX_INDEX; j >= 0; --j)
        {
            ...
            for (i = 0; i <= MAX_INDEX; ++i)
            {
                ...
                double x = sin(1.0 * i / 3600 * 5   * 2 * PI);
                double y = sin(1.0 * j / 3600 * 7.5 * 2 * PI);
